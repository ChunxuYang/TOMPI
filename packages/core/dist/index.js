...
var UserBehaviorDetector = import_core.Extension.create({
...
var Editor3 = () => {
  ...
  const editor = (0, import_react3.useEditor)({
    ...
    onUpdate() {
      ...
      const timeout = setTimeout(() => {
        ...
        (0, import_sonner.toast)("Seems like your writing is blocked", {
            ...
            import_sonner.toast.promise(
              ...
              ),
              {
                ...
                success: (completion2) => {
                  ...
                  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "space-y-2", children: ideas.map((idea, index) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                    Button,
                    {
                      variant: "outline",
                      className: "w-full",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_sonner2.Toaster, { position: "bottom-left" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_react3.EditorContent, { editor }),
