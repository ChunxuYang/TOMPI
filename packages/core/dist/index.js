...
// src/components/editor/extensions/ai-highlight.tsx
var import_core = require("@tiptap/core");
var import_react2 = require("@tiptap/react");
var import_jsx_runtime4 = require("react/jsx-runtime");
var AiHighlightNode = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react2.NodeViewWrapper, { className: "ai-highlight inline group", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(HoverCard, { openDelay: 0, closeDelay: 200, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(HoverCardTrigger, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: textCN, contentEditable: false, children: props.node.attrs.text }) }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(HoverCardContent, { className: "space-y-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "text-sm", children: [
        "...",
        " ",
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "text-green-600", children: props.node.attrs.correction }),
        " ",
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "text-red-600 line-through", children: props.node.attrs.text }),
        " ",
        "..."
      ] }),
...
var AiHighlightExtenstion = import_core.Node.create({
  name: "aiHighlight",
  group: "inline",
  inline: true,
  content: "text*",
  ...
  addNodeView() {
    return (0, import_react2.ReactNodeViewRenderer)(AiHighlightNode);
  }
});
var ai_highlight_default = AiHighlightExtenstion;

// src/components/editor/extensions/user-behavior-detector.tsx
var import_core2 = require("@tiptap/core");
var UserBehaviorDetector = import_core2.Extension.create({
  ...
  onBeforeCreate() {
    ...
    this.storage.user_behavior = () => ({
      duration_block: 0,
      typing_speed: this.storage.character_count / (Date.now() - this.storage.start_time) * 1e3,
      sentence_complete: 0,
      revision_frequency: 0,
      prob_distraction: this.storage.distraction_count
      // finished
    });
  },
  onUpdate() {
  ...
  onTransaction({ transaction }) {
    if (Date.now() - this.storage.start_time > 2e4) {
      this.storage.start_time = Date.now();
      this.storage.character_count = 0;
    }
...
var user_behavior_detector_default = UserBehaviorDetector;
...
var Editor3 = () => {
  ...
  const editor = (0, import_react4.useEditor)({
    extensions: [
      ...
      //   },
      // }),
      ai_highlight_default.configure({}),
      user_behavior_detector_default
    ],
    editorProps: {
      attributes: {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_react4.EditorContent, { editor }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Card, { className: "absolute top-5 left-5", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(CardContent, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "space-y-4", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "space-y-2", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("p", { className: "text-sm text-muted-foreground", children: [
                editor.storage.userBehaviorDetector.user_behavior().typing_speed.toFixed(2),
                " ",
                "chars/s"
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "space-y-2", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("p", { className: "text-sm text-muted-foreground", children: [
                editor.storage.userBehaviorDetector.user_behavior().prob_distraction,
                " ",
                "times"
              ] })
            ] })
