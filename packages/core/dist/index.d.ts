...
declare function Editor({ debugMode, onUserBehaviorChange, }: EditorProps): react_jsx_runtime.JSX.Element;

declare function notification(message: string, data?: ExternalToast): string | number;
declare function highlight(editor: Editor$1, text: string, highlight: string): string;
declare const UI: {
