...
import { useAtomValue as useAtomValue7 } from "jotai";
import {
...
var currentTimeTravelLogAtom = atom3([]);
var timeTravelLogListAtom = atom3([]);
...
var timeTravelStateAtom = atom3(
  "recording" /* Recording */
);
var latestEditorStateAtom = atom3(null);

// src/components/time-travel/index.tsx
import { useLexicalComposerContext as useLexicalComposerContext6 } from "@lexical/react/LexicalComposerContext";

// src/components/time-travel/recorder.tsx
import { useAtom as useAtom4, useSetAtom as useSetAtom2 } from "jotai";
...
function LogList() {
  ...
  const [timeTravelLogList, setTimeTravelLogList] = useAtom3(
  ...
  return /* @__PURE__ */ jsx9("div", { className: "flex flex-col space-y-2 w-full", children: timeTravelLogList.length === 0 ? /* @__PURE__ */ jsx9("div", { className: "text-center text-muted-foreground text-sm", children: "No logs yet." }) : /* @__PURE__ */ jsxs3(Table, { children: [
    ...
    /* @__PURE__ */ jsx9(TableBody, { children: timeTravelLogList.map((log, index) => /* @__PURE__ */ jsxs3(TableRow, { children: [
...
function Recorder() {
  ...
  const [timeTravelRecorderState, setTimeTravelRecorderState] = useAtom4(
    timeTravelRecorderStateAtom
  );
  const setTimeTravelLogList = useSetAtom2(timeTravelLogListAtom);
  ...
  return /* @__PURE__ */ jsxs4("div", { className: "flex flex-col space-y-4 w-full", children: [
    ...
    /* @__PURE__ */ jsx10(LogList, {})
  ] });
}

// src/components/time-travel/replayer.tsx
import { useAtom as useAtom5, useAtomValue as useAtomValue5, useSetAtom as useSetAtom3 } from "jotai";
...
function GridSelect({
  ...
  return /* @__PURE__ */ jsxs7("div", { className: "flex flex-col space-y-3", children: [
    label && /* @__PURE__ */ jsx17(TooltipProvider, { children: /* @__PURE__ */ jsxs7("div", { className: "flex flex-row items-center", children: [
      /* @__PURE__ */ jsx17(Label2, { children: label }),
      /* @__PURE__ */ jsxs7(Tooltip, { delayDuration: 100, children: [
    ...
    /* @__PURE__ */ jsxs7("div", { className: "space-y-1", children: [
      /* @__PURE__ */ jsx17("div", { className: `flex flex-row divide-solid divide-x border rounded`, children: options.map((option, index) => /* @__PURE__ */ jsx17(
        Toggle,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ jsxs7("div", { className: "flex flex-row justify-between", children: [
        /* @__PURE__ */ jsx17(Label2, { className: "text-xs text-muted-foreground", children: leftIndication }),
        /* @__PURE__ */ jsx17(Label2, { className: "text-xs text-muted-foreground", children: rightIndication })
      ] })
    ] })
  ] });
}
...
function PauseForm({ open, onOpenChange }) {
  return /* @__PURE__ */ jsx19(Sheet, { defaultOpen: false, open, onOpenChange, children: /* @__PURE__ */ jsxs9(SheetContent, { className: "flex flex-col text-left h-screen", children: [
    /* @__PURE__ */ jsxs9(SheetHeader, { children: [
      /* @__PURE__ */ jsx19(SheetTitle, { children: "What was your mental state when you were blocked?" }),
      /* @__PURE__ */ jsx19(SheetDescription, { children: "Click on the possibilites below." })
    ] }),
    /* @__PURE__ */ jsxs9(Tabs, { defaultValue: "step-1", className: "w-full flex-1 flex flex-col", children: [
      /* @__PURE__ */ jsxs9(TabsList, { className: "grid w-full grid-cols-2", children: [
        /* @__PURE__ */ jsx19(TabsTrigger, { value: "step-1", children: "Step 1" }),
        /* @__PURE__ */ jsx19(TabsTrigger, { value: "step-2", children: "Step 2" })
      ] }),
      /* @__PURE__ */ jsxs9(ScrollArea, { className: "flex-1 max-h-[600px] pr-4", children: [
        /* @__PURE__ */ jsxs9(TabsContent, { value: "step-1", className: "flex-1 flex flex-col", children: [
          /* @__PURE__ */ jsxs9("div", { className: "flex flex-col space-y-4 mt-4 mb-4", children: [
            /* @__PURE__ */ jsx19(Label, { className: "text-xl", children: "Planning" }),
            /* @__PURE__ */ jsx19("ul", { className: "space-y-4 list-disc", children: [
              "Generating ideas to write about",
              "Organizing ideas to write about",
              "Setting the writing goal"
            ].map((item, index) => /* @__PURE__ */ jsx19("li", { children: /* @__PURE__ */ jsx19(
              GridSelect,
              {
                label: item,
          ...
          /* @__PURE__ */ jsxs9("div", { className: "flex flex-col space-y-4 mt-4 mb-4", children: [
            /* @__PURE__ */ jsx19(Label, { className: "text-xl", children: "Translating" }),
            /* @__PURE__ */ jsx19("ul", { className: "space-y-4", children: /* @__PURE__ */ jsx19(
              GridSelect,
              {
                options: ["1", "2", "3", "4", "5", "6", "7"],
                value: "1",
          ...
          /* @__PURE__ */ jsxs9("div", { className: "flex flex-col space-y-4 mt-4 mb-4", children: [
            /* @__PURE__ */ jsx19(Label, { className: "text-xl", children: "Reviewing" }),
            /* @__PURE__ */ jsx19("ul", { className: "space-y-4 list-disc", children: ["Evaluating written text", "Revising written text"].map(
              (item, index) => /* @__PURE__ */ jsx19("li", { children: /* @__PURE__ */ jsx19(
                GridSelect,
                {
                  label: item,
                  options: ["1", "2", "3", "4", "5", "6", "7"],
        ...
        /* @__PURE__ */ jsx19(TabsContent, { value: "step-2", children: /* @__PURE__ */ jsx19(ScrollArea, { className: "flex-1 pr-4", children: /* @__PURE__ */ jsxs9("div", { className: "flex flex-col space-y-4 mt-4 mb-4", children: [
          /* @__PURE__ */ jsx19(Label, { className: "text-xl", children: "What kinds of AI assistance can help with this block?" }),
          /* @__PURE__ */ jsx19("ul", { className: "space-y-4 list-disc", children: [
    ...
    /* @__PURE__ */ jsx19(SheetFooter, { children: /* @__PURE__ */ jsx19(Button, { type: "submit", children: "Save changes" }) })
  ] }) });
}
...
function Replayer() {
  ...
  const timeTravelLogs = useAtomValue5(currentTimeTravelLogAtom);
  const latestEditorState = useAtomValue5(latestEditorStateAtom);
  const [replayState, setReplayState] = useAtom5(timeTravelReplayerStateAtom);
  const [sliderValue, setSliderValue] = useState2(0);
  ...
  const [playbackSpeedIndex, setPlaybackSpeedIndex] = useState2(2);
  useEffect4(() => {
  ...
  return /* @__PURE__ */ jsxs10("div", { className: "flex flex-col space-y-2 w-full", children: [
    /* @__PURE__ */ jsx20(PauseForm, { open: pauseFormOpen, onOpenChange: setPauseFormOpen }),
    /* @__PURE__ */ jsxs10("div", { className: "grid grid-cols-3 items-center", children: [
      /* @__PURE__ */ jsx20(
        Toggle,
        {
          ...
          children: {
            ["idle" /* Idle */]: /* @__PURE__ */ jsx20(PlayIcon2, { className: "w-4 h-4" }),
            ["playing" /* Playing */]: /* @__PURE__ */ jsx20(StopIcon2, { className: "w-4 h-4" }),
            ["finished" /* Finished */]: /* @__PURE__ */ jsx20(ReloadIcon, { className: "w-4 h-4" })
          }[replayState]
        }
      ),
      /* @__PURE__ */ jsxs10(Label, { className: "justify-self-center", children: [
        "Step ",
        sliderValue,
        "/",
        totalSteps
    ...
    /* @__PURE__ */ jsx20("div", { className: "flex justify-between items-center", children: /* @__PURE__ */ jsx20(
      Button,
      {
        variant: "link",
        onClick: () => {
...
function TimeTravel() {
  ...
  const timeTravelState = useAtomValue6(timeTravelStateAtom);
  useEffect5(() => {
  ...
  return /* @__PURE__ */ jsx21(Fragment, { children: /* @__PURE__ */ jsxs11(Card, { children: [
    /* @__PURE__ */ jsxs11(CardHeader, { children: [
      /* @__PURE__ */ jsx21(CardTitle, { children: "Time Travel" }),
      /* @__PURE__ */ jsx21(CardDescription, { children: "See how your essay has evolved." })
    ] }),
    /* @__PURE__ */ jsx21(CardContent, { className: "flex justify-between items-center space-x-2", children: {
      ["recording" /* Recording */]: /* @__PURE__ */ jsx21(Recorder, {}),
      ["relaying" /* Replaying */]: /* @__PURE__ */ jsx21(Replayer, {})
    }[timeTravelState] })
  ] }) });
}
...
function TimeTravelPlugin() {
  return /* @__PURE__ */ jsx22("div", { className: "absolute top-0 left-0 z-20 m-4", children: /* @__PURE__ */ jsx22(TimeTravel, {}) });
}
...
var useLeavingCount = (onReturning) => {
  const [leaving, setLeaving] = useState3(false);
...
function UserBehaviorDetectorPlugin() {
  ...
  const setTypingSpeed = useSetAtom4(typingSpeedAtom);
  const setProbDistraction = useSetAtom4(probDistractionAtom);
  const lastCharacterCount = React13.useRef(0);
  const lastTime = React13.useRef(Date.now());
...
function Editor({
  ...
  const typingSpeed = useAtomValue7(typingSpeedAtom);
  const probDistraction = useAtomValue7(probDistractionAtom);
  const userBehavior = useAtomValue7(userBehaviorAtom);
  useEffect8(() => {
    onUserBehaviorChange == null ? void 0 : onUserBehaviorChange(userBehavior);
  }, [userBehavior]);
  return /* @__PURE__ */ jsxs12("div", { className: "relative h-full overflow-auto", children: [
    /* @__PURE__ */ jsx24(Toaster, { position: "bottom-left", theme }),
    debugMode && /* @__PURE__ */ jsxs12(Card, { className: "fixed bottom-10 right-10", children: [
      /* @__PURE__ */ jsx24(CardHeader, { children: /* @__PURE__ */ jsx24(CardTitle, { children: "User Behavior" }) }),
      /* @__PURE__ */ jsx24(CardContent, { children: /* @__PURE__ */ jsxs12("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs12("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx24("p", { className: "text-sm font-medium leading-none", children: "Typing Speed" }),
        ...
        /* @__PURE__ */ jsxs12("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx24("p", { className: "text-sm font-medium leading-none", children: "Distraction Count" }),
          /* @__PURE__ */ jsxs12("p", { className: "text-sm text-muted-foreground", children: [
            probDistraction,
            " times"
          ] })
      ...
      /* @__PURE__ */ jsx24(CardFooter, {})
    ] }),
    /* @__PURE__ */ jsxs12("div", { className: "h-full flex flex-row justify-center space-x-4", children: [
      /* @__PURE__ */ jsx24(
        "div",
        {
          className: "w-full relative p-6 rounded-xl border bg-card text-card-foreground shadow",
          children: /* @__PURE__ */ jsxs12(LexicalComposer, { initialConfig: config, children: [
            /* @__PURE__ */ jsx24(
              RichTextPlugin,
              {
                contentEditable: /* @__PURE__ */ jsx24(ContentEditable, {}),
                placeholder: null,
                ErrorBoundary: LexicalErrorBoundary
              }
            ),
            /* @__PURE__ */ jsx24(AutoFocusPlugin, {}),
            /* @__PURE__ */ jsx24(MarkdownShortcutPlugin, { transformers: TRANSFORMERS }),
            /* @__PURE__ */ jsx24(HistoryPlugin, {}),
            /* @__PURE__ */ jsx24(ListPlugin, {}),
            /* @__PURE__ */ jsx24(LinkPlugin, {}),
            /* @__PURE__ */ jsx24(TabIndentationPlugin, {}),
            /* @__PURE__ */ jsx24(AiHighlightPlugin, { debugMode }),
            /* @__PURE__ */ jsx24(UserBehaviorDetectorPlugin, {}),
            /* @__PURE__ */ jsx24(CommentPlugin, {}),
            /* @__PURE__ */ jsx24(Fragment2, { children: !!debugMode && /* @__PURE__ */ jsx24("div", { className: "absolute bottom-0 left-0 border border-red-500 overflow-auto max-w-full h-1/2", children: /* @__PURE__ */ jsx24(TreeViewPlugin, {}) }) }),
            /* @__PURE__ */ jsx24(TimeTravelPlugin, {})
          ] })
        }
      ),
      /* @__PURE__ */ jsx24(Separator, { orientation: "vertical" }),
      /* @__PURE__ */ jsx24(CommentList, {})
    ] })
  ] });
}
...
function useTompiUI() {
  const setComments = useSetAtom5(commentsAtom);
