...
function GridSelect({
  ...
  return /* @__PURE__ */ jsxs5("div", { className: "flex flex-col space-y-3", children: [
    label && /* @__PURE__ */ jsx14(TooltipProvider, { children: /* @__PURE__ */ jsxs5("div", { className: "flex flex-row items-center", children: [
      /* @__PURE__ */ jsx14(Label2, { children: label }),
      /* @__PURE__ */ jsxs5(Tooltip, { delayDuration: 100, children: [
        /* @__PURE__ */ jsx14(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsx14(Button, { size: "icon", variant: "link", children: /* @__PURE__ */ jsx14(InfoCircledIcon, { className: "w-4 h-4" }) }) }),
        /* @__PURE__ */ jsx14(TooltipContent, { children: label })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs5("div", { className: "space-y-1", children: [
      /* @__PURE__ */ jsx14("div", { className: `flex flex-row divide-solid divide-x border rounded`, children: options.map((option, index) => /* @__PURE__ */ jsx14(
        Toggle,
        {
          variant: "outline",
      ...
      /* @__PURE__ */ jsxs5("div", { className: "flex flex-row justify-between", children: [
        /* @__PURE__ */ jsx14(Label2, { className: "text-xs text-muted-foreground", children: leftIndication }),
        /* @__PURE__ */ jsx14(Label2, { className: "text-xs text-muted-foreground", children: rightIndication })
      ] })
    ] })
  ] });
}
...
function PauseForm({ open, onOpenChange }) {
  return /* @__PURE__ */ jsx16(Sheet, { defaultOpen: false, open, onOpenChange, children: /* @__PURE__ */ jsxs7(SheetContent, { className: "flex flex-col text-left h-screen", children: [
    /* @__PURE__ */ jsxs7(SheetHeader, { children: [
      /* @__PURE__ */ jsx16(SheetTitle, { children: "What was your mental state when you were blocked?" }),
      /* @__PURE__ */ jsx16(SheetDescription, { children: "Click on the possibilites below." })
    ] }),
    /* @__PURE__ */ jsxs7(Tabs, { defaultValue: "step-1", className: "w-full flex-1 flex flex-col", children: [
      /* @__PURE__ */ jsxs7(TabsList, { className: "grid w-full grid-cols-2", children: [
        /* @__PURE__ */ jsx16(TabsTrigger, { value: "step-1", children: "Step 1" }),
        /* @__PURE__ */ jsx16(TabsTrigger, { value: "step-2", children: "Step 2" })
      ] }),
      /* @__PURE__ */ jsxs7(ScrollArea, { className: "flex-1 max-h-[600px] pr-4", children: [
        /* @__PURE__ */ jsxs7(TabsContent, { value: "step-1", className: "flex-1 flex flex-col", children: [
          /* @__PURE__ */ jsxs7("div", { className: "flex flex-col space-y-4 mt-4 mb-4", children: [
            /* @__PURE__ */ jsx16(Label, { className: "text-xl", children: "Planning" }),
            /* @__PURE__ */ jsx16("ul", { className: "space-y-4 list-disc", children: [
              "Generating ideas to write about",
              "Organizing ideas to write about",
              "Setting the writing goal"
            ].map((item, index) => /* @__PURE__ */ jsx16("li", { children: /* @__PURE__ */ jsx16(
              GridSelect,
              {
                label: item,
          ...
          /* @__PURE__ */ jsxs7("div", { className: "flex flex-col space-y-4 mt-4 mb-4", children: [
            /* @__PURE__ */ jsx16(Label, { className: "text-xl", children: "Translating" }),
            /* @__PURE__ */ jsx16("ul", { className: "space-y-4", children: /* @__PURE__ */ jsx16(
              GridSelect,
              {
                options: ["1", "2", "3", "4", "5", "6", "7"],
                value: "1",
          ...
          /* @__PURE__ */ jsxs7("div", { className: "flex flex-col space-y-4 mt-4 mb-4", children: [
            /* @__PURE__ */ jsx16(Label, { className: "text-xl", children: "Reviewing" }),
            /* @__PURE__ */ jsx16("ul", { className: "space-y-4 list-disc", children: ["Evaluating written text", "Revising written text"].map(
              (item, index) => /* @__PURE__ */ jsx16("li", { children: /* @__PURE__ */ jsx16(
                GridSelect,
                {
                  label: item,
                  options: ["1", "2", "3", "4", "5", "6", "7"],
        ...
        /* @__PURE__ */ jsx16(TabsContent, { value: "step-2", children: /* @__PURE__ */ jsx16(ScrollArea, { className: "flex-1 pr-4", children: /* @__PURE__ */ jsxs7("div", { className: "flex flex-col space-y-4 mt-4 mb-4", children: [
          /* @__PURE__ */ jsx16(Label, { className: "text-xl", children: "What kinds of AI assistance can help with this block?" }),
          /* @__PURE__ */ jsx16("ul", { className: "space-y-4 list-disc", children: [
    ...
    /* @__PURE__ */ jsx16(SheetFooter, { children: /* @__PURE__ */ jsx16(Button, { type: "submit", children: "Save changes" }) })
  ] }) });
}
...
function TimeTravel() {
  ...
  return /* @__PURE__ */ jsxs8(Fragment, { children: [
    /* @__PURE__ */ jsx17(PauseForm, { open: pauseFormOpen, onOpenChange: setPauseFormOpen }),
    /* @__PURE__ */ jsxs8(Card, { children: [
      /* @__PURE__ */ jsxs8(CardHeader, { children: [
        /* @__PURE__ */ jsx17(CardTitle, { children: "Time Travel" }),
        /* @__PURE__ */ jsx17(CardDescription, { children: "See how your essay has evolved." })
      ] }),
      /* @__PURE__ */ jsxs8(CardContent, { className: "flex justify-between items-center space-x-2", children: [
        timeTravelState === "idle" /* Idle */ && /* @__PURE__ */ jsxs8(
          Button,
          {
            variant: "default",
            onClick: () => {
            ...
            children: [
              /* @__PURE__ */ jsx17(PlayIcon, { className: "w-4 h-4 mr-2" }),
              "Start Recording"
            ]
          }
        ),
        timeTravelState === "recording" /* Recording */ && /* @__PURE__ */ jsxs8(
          Button,
          {
            variant: "outline",
            onClick: () => {
            ...
            children: [
              /* @__PURE__ */ jsx17(StopIcon, { className: "w-4 h-4 mr-2" }),
              "Stop Recording"
            ]
          }
        ),
        timeTravelState === "ready" /* Ready */ && /* @__PURE__ */ jsxs8(Fragment, { children: [
          /* @__PURE__ */ jsxs8(
            Button,
            {
              variant: "secondary",
          ...
          /* @__PURE__ */ jsxs8(
            Button,
            {
              ...
              children: [
                /* @__PURE__ */ jsx17(LoopIcon, { className: "w-4 h-4 mr-2" }),
                "Replay"
              ]
            }
          )
        ] }),
        timeTravelState === "finished" /* Finished */ && /* @__PURE__ */ jsxs8("div", { className: "flex flex-col space-y-2 w-full", children: [
          /* @__PURE__ */ jsxs8("div", { className: "grid grid-cols-3 items-center", children: [
            /* @__PURE__ */ jsx17(
              Toggle,
              {
                ...
                children: {
                  ["idle" /* Idle */]: /* @__PURE__ */ jsx17(PlayIcon, { className: "w-4 h-4" }),
                  ["playing" /* Playing */]: /* @__PURE__ */ jsx17(StopIcon, { className: "w-4 h-4" }),
                  ["finished" /* Finished */]: /* @__PURE__ */ jsx17(ReloadIcon, { className: "w-4 h-4" })
                }[replayState]
              }
            ),
            /* @__PURE__ */ jsxs8(Label, { className: "justify-self-center", children: [
              "Step ",
              sliderValue,
              "/",
              totalSteps
...
function TimeTravelPlugin() {
  ...
  return /* @__PURE__ */ jsx18("div", { className: "absolute top-0 left-0 z-20 m-4", children: /* @__PURE__ */ jsx18(TimeTravel, {}) });
}
...
import React12, { useEffect as useEffect6 } from "react";
...
function UserBehaviorDetectorPlugin() {
  ...
  const lastCharacterCount = React12.useRef(0);
  const lastTime = React12.useRef(Date.now());
...
function Editor({
  ...
  return /* @__PURE__ */ jsxs9("div", { className: "relative h-full overflow-auto", children: [
    /* @__PURE__ */ jsx20(Toaster, { position: "bottom-left", theme }),
    debugMode && /* @__PURE__ */ jsxs9(Card, { className: "fixed bottom-10 right-10", children: [
      /* @__PURE__ */ jsx20(CardHeader, { children: /* @__PURE__ */ jsx20(CardTitle, { children: "User Behavior" }) }),
      /* @__PURE__ */ jsx20(CardContent, { children: /* @__PURE__ */ jsxs9("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxs9("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx20("p", { className: "text-sm font-medium leading-none", children: "Typing Speed" }),
        ...
        /* @__PURE__ */ jsxs9("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx20("p", { className: "text-sm font-medium leading-none", children: "Distraction Count" }),
          /* @__PURE__ */ jsxs9("p", { className: "text-sm text-muted-foreground", children: [
            probDistraction,
            " times"
          ] })
      ...
      /* @__PURE__ */ jsx20(CardFooter, {})
    ] }),
    /* @__PURE__ */ jsxs9("div", { className: "h-full flex flex-row justify-center space-x-4", children: [
      /* @__PURE__ */ jsx20(
        "div",
        {
          className: "w-full relative p-6 rounded-xl border bg-card text-card-foreground shadow",
          children: /* @__PURE__ */ jsxs9(LexicalComposer, { initialConfig: config, children: [
            /* @__PURE__ */ jsx20(
              RichTextPlugin,
              {
                contentEditable: /* @__PURE__ */ jsx20(ContentEditable, {}),
                placeholder: null,
                ErrorBoundary: LexicalErrorBoundary
              }
            ),
            /* @__PURE__ */ jsx20(AutoFocusPlugin, {}),
            /* @__PURE__ */ jsx20(MarkdownShortcutPlugin, { transformers: TRANSFORMERS }),
            /* @__PURE__ */ jsx20(HistoryPlugin, {}),
            /* @__PURE__ */ jsx20(ListPlugin, {}),
            /* @__PURE__ */ jsx20(LinkPlugin, {}),
            /* @__PURE__ */ jsx20(TabIndentationPlugin, {}),
            /* @__PURE__ */ jsx20(AiHighlightPlugin, { debugMode }),
            /* @__PURE__ */ jsx20(UserBehaviorDetectorPlugin, {}),
            /* @__PURE__ */ jsx20(CommentPlugin, {}),
            /* @__PURE__ */ jsx20(Fragment2, { children: !!debugMode && /* @__PURE__ */ jsx20("div", { className: "absolute bottom-0 left-0 border border-red-500 overflow-auto max-w-full h-1/2", children: /* @__PURE__ */ jsx20(TreeViewPlugin, {}) }) }),
            /* @__PURE__ */ jsx20(TimeTravelPlugin, {})
          ] })
        }
      ),
      /* @__PURE__ */ jsx20(Separator, { orientation: "vertical" }),
      /* @__PURE__ */ jsx20(CommentList, {})
    ] })
  ] });
}
