...
import React9, { useEffect as useEffect6 } from "react";
...
function CommentItem({ commentAtom }) {
  ...
  return /* @__PURE__ */ jsxs3(Card, { children: [
    /* @__PURE__ */ jsx7(CardHeader, { children: /* @__PURE__ */ jsx7(CardTitle, { children: comment.comment }) }),
    /* @__PURE__ */ jsxs3(CardFooter, { className: "flex justify-between", children: [
      /* @__PURE__ */ jsx7(Button, { variant: "outline", children: "Decline" }),
      /* @__PURE__ */ jsx7(Button, { children: "Accept" })
    ] })
  ] });
}
...
function CommentList() {
  ...
  return /* @__PURE__ */ jsx8("div", { className: "space-y-4 p-4", children: comments.map((comment, id) => /* @__PURE__ */ jsx8(CommentItem, { commentAtom: comment }, id)) });
}
...
function Editor({
  ...
  const typingSpeed = useAtomValue3(typingSpeedAtom);
  const probDistraction = useAtomValue3(probDistractionAtom);
  const userBehavior = useAtomValue3(userBehaviorAtom);
  useEffect7(() => {
    onUserBehaviorChange == null ? void 0 : onUserBehaviorChange(userBehavior);
  }, [userBehavior]);
  return /* @__PURE__ */ jsxs4("div", { className: "relative border rounded-lg shadow-sm h-full p-10 bg-card flex flex-col overflow-auto", children: [
    ...
    debugMode && /* @__PURE__ */ jsxs4(Card, { className: "fixed bottom-10 right-10", children: [
      ...
      /* @__PURE__ */ jsx9(CardContent, { children: /* @__PURE__ */ jsxs4("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxs4("div", { className: "flex-1 flex flex-row", children: [
      /* @__PURE__ */ jsxs4(LexicalComposer, { initialConfig: config, children: [
        /* @__PURE__ */ jsx9(
          RichTextPlugin,
          {
            contentEditable: /* @__PURE__ */ jsx9(ContentEditable, {}),
            placeholder: /* @__PURE__ */ jsx9("span", { className: "lexical-placeholder", children: "Input something..." }),
